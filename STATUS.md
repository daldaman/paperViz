...
- Both real papers are embedded in the Google Sites hub as hidden "Full page embed" pages (`/wfh-interactive` — rebuilt to full-page 2026-07-30 with its URL preserved — and `/dark-banking-interactive`).
